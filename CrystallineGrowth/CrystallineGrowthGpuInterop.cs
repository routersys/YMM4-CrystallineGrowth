...
internal sealed class CrystallineGrowthGpuInterop : IDisposable
{
    ...
    private CrystallineGrowthGpuInterop(
    ...
    public static unsafe CrystallineGrowthGpuInterop? TryCreate(IGraphicsDevicesAndContext devices)
    {
        ...
        try
        {
            ...
            return new CrystallineGrowthGpuInterop(device, d3dDevice, d3dContext, fence, renderContext, d3d12Fence);
        }
        catch
        {
