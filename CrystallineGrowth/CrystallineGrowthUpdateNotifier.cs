...
internal static class CrystallineGrowthUpdateNotifier
{
    private const string Owner = "routersys";
    private const string Repository = "YMM4-CrystallineGrowth";
    ...
    private static async Task RunAsync()
    {
        try
        {
            ...
            {
                CurrentVersion = PluginVersion.FromAssemblyInformationalVersion(typeof(CrystallineGrowthUpdateNotifier)),
    ...
    private static Task ShowNotificationAsync(UpdateNotification notification, CancellationToken cancellationToken)
    {
        ...
        return application.Dispatcher.InvokeAsync(() =>
            MessageBox.Show(notification.Message, Texts.CrystallineGrowth, MessageBoxButton.OK, MessageBoxImage.Information)).Task;
    }
}
